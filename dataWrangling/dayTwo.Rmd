...
- more info: https://haven.tidyverse.org/reference/read_dta.html 
...
## Before we get into today's content
...
```{r}
# notice where the comma is in the next line
...
For now, we are going to stick with that stataExample data from yesterday:
...
1.  Select the same variables, but also include Rater.
    - Every lvi, effect, leader, and cred variable, plus Rater
...
Correlation code from yesterday: 
...
- Documentation: https://tidyr.tidyverse.org/dev/articles/pivot.html
    - This is a very clear and thorough vignette on pivoting, worth your while. 
...
- What tools (*verbs*) would you use to accomplish the goals in the previous step? If you have come up with steps that involve tools we haven't covered, I encourage you to browse through the rest of the [tidyverse](https://www.tidyverse.org/packages/). 
...
*TODO* create a prompt for day 2.
