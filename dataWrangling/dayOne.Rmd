...
The whole point of the <span class="pack">tidyverse</span> is to offer a grammar of verbs. It is going to help us in a lot of the situations that we are going to be seeing.
...
But if you will only need a few tidyverse packages, you can load them directly.
