...
- Because of the schedule, I encourage each group to form early and think about possible data sets early as well. A rough outline for the week might look like what's outlined below. That said, nothing is set in stone with regards to the hackathon before Thursday. 
  ...
  - Thursday: Hack! 
- The hackathon outputs will be considered **group work.** I expect each group member to contribute to the final output. The following will be considered a violation of the Academic Honor Code:
  1. Taking credit for a group project without doing the work
  2. Attempting to claim that a group project was a solo project
...
I will check the form responses each day and, if necessary, addres them the following morning. 
