...
## Logistics
### Course dates 
10/05/2020 - 10/08/2020, 1:00pm - 4:10pm
...
You will get into groups of 5 people, choose a data set, cobble it into some shape, and give a brief presentation. 
...
- Your learning group will be your team for the hackathon.
- Because of the schedule, I encourage each group to get together early and think about possible data sets early as well. A rough outline for the week might look like what's below. That said, nothing is set in stone with regards to the hackathon before Thursday. 
  - Monday: Form groups
...
[**Click here to access the feedback form**](https://forms.gle/xE6JMuJgSdqVZJMZ9)

Please use the form to list any comments, concerns, etc. with regards to the class. 
I will check the form responses each day and, if necessary, address them the following afternoon. 
