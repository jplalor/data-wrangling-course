...
author: |
  | John Lalor (thanks to Seth Berry for much of the content)
  | john.lalor@nd.edu
output:
  html_document:
    theme: flatly
...
### My office
Mendoza 338B (You'll be spending a lot of time with me this week, but afterwards you can always drop by or send me an email to schedule a meeting.)
...
Instead, your mission is to explain (using the parlance of our times) how you would solve the wrangling problem. 
