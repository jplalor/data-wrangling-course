...
We'll be making teams and (starting to) select data sets for tomorrow at the end of today's class, so start thinking about potential teammates (2-4 students per team), team names, and data set ideas.
